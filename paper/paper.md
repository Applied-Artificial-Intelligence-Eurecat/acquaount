...
authors:
  - given-names: Joel
    surname: Aumedes Serrano
    orcid: 0009-0006-9011-0853
    affiliation: 1
  - given-names: Josep
    surname: Pijuan Parra
    affiliation: 1
  - given-names: Robert
    surname: Sanfeliu Prat
    affiliation: 1
affiliations:
...
![Figure 1 - Diagram representing how WoT simplifies the interaction between apps and devices.](diagramawot.png)

Taking a look at Figure 1, it is seen how providing a uniform interface for objects facilitates the tasks of the IoT applications, simplifying the connections and creating easily maintainable and expandable applications.
...
# FIGURE 2
Figure 2 - Diagram of the SensorThings Sensing part, based on the SensorThings Data Model
...
# FIGURE 3
Figure 3 - Diagram of the WoT platform and all related services.
...
# FIGURE 4
Figure 4 - Diagram of WoT being used as the interface to access the SensorThings data model.
...
# FIGURE 5
Figure 5 - Map of the Pilot Locations of the ACQUAOUNT Project.
