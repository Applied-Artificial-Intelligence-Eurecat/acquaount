...
The Sensing part is centered around the SensorThings Data Model, seen in \autoref{fig2}.  

![Diagram of the SensorThings Sensing part, based on the SensorThings Data Model.\label{fig2}](diagramasensorthings.png){ width=95% }  
...
![Map of the Pilot Locations of the ACQUAOUNT Project.\label{fig5}](Mapa.png){ width=80% }  
