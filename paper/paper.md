...
Taking a look at \autoref{fig1}, it \ref{fig1} is seen how providing a uniform interface for objects facilitates the tasks of the IoT applications, simplifying the connections and creating easily maintainable and expandable applications.   
...
![Diagram of the SensorThings Sensing part, based on the SensorThings Data Model.](diagramasensorthings.png){ width=95% }  
